...
<div class="page-con-content landing-con-override">
	...
	<div class="landing-con-main">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Мої роботи зробленні в Blender за цей рік<br>
							 </h1>
							 <p>
								Творець Данило								
                            </p>
				...
				<div class='landing-img-hero' style="background: url(/img/room.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="landing-con-video darkmode-feature">
		<div class="content-con-outside">
			...
			<div class="content-btn-left-left darkmode-arrow-right right" href="#myCarousel" data-slide="next">
			</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
								Я використовую дискор для зручності. Ми проводимо розіграші щотижня.Приєднайся і отримай мій крус по Blender абсолютно безкоштовно!
								</p>
							</div>
							<a href="https://discord.com/channels/1097821060935733271/1097821061707464756" target="_blank">
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							<div class="github-tx1-mantra darkmode-txt">
								<h2>Мій Youtube канал</h2>
								<div class="landing-con-divider">
								</div>
							</div>
							<div class="github-tx2-mantra darkmode-txt">
								<p>
								Я намагаюся вчитися кожного дня та отримувати кращі результати та я переконуюсь якщо ви приєднаєтесь до мого каналу на Youtube ми пройдемо цей шлях разом
								</p>
							</div>
							<a href="https://www.youtube.com/channel/UCc_UQDNPsqe1-ZW7PiXD7YQ" target="_blank">
		...
		<div class="content-con-outside" >
			<div class="content-con-inside" >
				<div class="patreon-con-container" >
					<!-- иконка аи -->
				<div class='patreon-con-container' style="background: url(/img/ai.jpg) no-repeat left; background-size: auto 300px;  object-fit: fill;">
					</div>
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							<div class="patreon-tx1-mantra">
								<h2>Всім дякую за увагу 
								</h2>
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
								Цей чудовий сайт створював сам автор і не заробив на цьому жодної копійки, будь ласка, зрозумійте автора та скиньте трохи грошей за його працю.<br>05168 7559 1014 1338<br>Дякую!
